...
<nav id="sidebar" class='mx-lt-5 bg-danger' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=view_new_donor" class="nav-item nav-view_new_donor"><span class='icon-field'><i class="fa fa-toolbox text-danger"></i></span> View New Donor</a>
			<a href="index.php?page=view_new_requester" class="nav-item nav-view_new_donor"><span class='icon-field'><i class="fa fa-toolbox text-danger"></i></span> View New Requester</a>
				<?php if($_SESSION['login_type'] == 1): ?>
				<a href="index.php?page=announcementn" class="nav-item nav-announcementn"><span class='icon-field'><i class="fa fa-th-list text-danger"></i></span> Announcements</a>
				...
				<a href="index.php?page=viewcomment" class="nav-item nav-viewcomment"><span class='icon-field'><i class="fa fa-users text-danger"></i></span> View Feedback</a>
