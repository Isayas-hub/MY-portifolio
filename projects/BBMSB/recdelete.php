...
<table border="0"width="300" border="0" bordercolor="#3399CC" bordercolor="#FFCCFF" bgcolor="#33CC99" align="center">
  <caption align="center"> <h2><i><b>Deleted Results!!</b></i></h2></caption><a href="homepage.html" title="Home">Back</a>
<tr>
    <td>
...
$query="delete from regdonors where ".$searchtype." = '".$searchterm."'";
