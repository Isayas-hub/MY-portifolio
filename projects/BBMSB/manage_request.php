...
<div class="container-fluid">
	<form action="" id="manage-request">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="patient"  value="<?php echo isset($patient) ? $patient :'' ?>" required="true">
		</div>
		<div class="form-group">
...
else if($('[name="volume"]').val() <=0){
			$('#msg').html('<div class="alert alert-danger">You can not request for zero volume.</div>')
			end_load()
			return false;
		}
