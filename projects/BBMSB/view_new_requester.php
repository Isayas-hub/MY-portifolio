					...
					<div class="card-body">
						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$regrequest = $conn->query("SELECT * FROM regrequest");
								while($row=$regrequest->fetch_assoc()):
...
<td class="">			
									...
									<td class="text-center">
										...
										<a href="appointment1.html" title="Home">Appoint</a>
										<a href="recdeleter.html" title="Home">Delete</a>
