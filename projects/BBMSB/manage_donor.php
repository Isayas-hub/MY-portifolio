...
<div class="container-fluid">
	<form action="" id="manage-donor">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="name"  maxlength="30"  pattern="[a-z]+" value="<?php echo isset($name) ? $name :'' ?>" required='true'>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="email" class="form-control" name="email" maxlength="50" value="<?php echo isset($email) ? $email :'' ?>" required='true'>
		</div>
		<div class="form-group">
