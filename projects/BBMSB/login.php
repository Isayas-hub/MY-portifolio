...
<body>
  ...
  <main id="main" class=" bg-danger">
  		...
  		<div id="login-left">
<img src="images1/login2.jpg" alt="" width="3008" height="372" border="0" align="top" id="images1" style="width:449px;height:411px;">
...
If You are Blood Donor or Blood Seeker 
<a href="fieldset.html" title="Home">Sign Up Here OR</a>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;<a href="drlogin.html" title="Home">login Here </a>
  					</form>
  				</div>
  			</div>
  			</div>
